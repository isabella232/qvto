...
public class GenericsSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case GenericsPackage.GENERIC_CLS: {
				GenericCls<?> genericCls = (GenericCls<?>)theEObject;
				T result = caseGenericCls(genericCls);
	 ...
	 * @return the result of interpreting the object as an instance of '<em>Generic Cls</em>'.
