...
public class GenericsAdapterFactory extends AdapterFactoryImpl {
	...
	protected GenericsSwitch<Adapter> modelSwitch =
		new GenericsSwitch<Adapter>() {
			@Override
			public <E extends Number> Adapter caseGenericCls(GenericCls<E> object) {
	...
	/**
	 * Creates a new adapter for an object of class '{@link generics.GenericCls <em>Generic Cls</em>}'.
	 * <!-- begin-user-doc -->
