...
public class ElementImpl extends EObjectImpl implements Element {
	...
	protected EClass eStaticClass() {
		return TestqvtPackage.Literals.ELEMENT;
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, TestqvtPackage.ELEMENT__NAME, oldName, name));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case TestqvtPackage.ELEMENT__NAME:
				return getName();
		}
