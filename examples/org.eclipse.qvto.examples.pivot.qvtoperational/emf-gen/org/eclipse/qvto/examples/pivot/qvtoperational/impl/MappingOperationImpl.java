 ...
 * </p>
 * <ul>
 *   <li>{@link org.eclipse.qvto.examples.pivot.qvtoperational.impl.MappingOperationImpl#getDisjunct <em>Disjunct</em>}</li>
 *   <li>{@link org.eclipse.qvto.examples.pivot.qvtoperational.impl.MappingOperationImpl#getInherited <em>Inherited</em>}</li>
 *   <li>{@link org.eclipse.qvto.examples.pivot.qvtoperational.impl.MappingOperationImpl#getMerged <em>Merged</em>}</li>
 *   <li>{@link org.eclipse.qvto.examples.pivot.qvtoperational.impl.MappingOperationImpl#getRefinedRelation <em>Refined Relation</em>}</li>
 *   <li>{@link org.eclipse.qvto.examples.pivot.qvtoperational.impl.MappingOperationImpl#getWhen <em>When</em>}</li>
 *   <li>{@link org.eclipse.qvto.examples.pivot.qvtoperational.impl.MappingOperationImpl#getWhere <em>Where</em>}</li>
 * </ul>
 *
 * @generated
 */
public class MappingOperationImpl extends ImperativeOperationImpl implements MappingOperation {
	 ...
	 * @ordered
	 */
	protected DummyRelation refinedRelation;
	 ...
	 * @generated
	 */
	public DummyRelation basicGetRefinedRelation() {
		return refinedRelation;
	}
	 ...
	 * @generated
	 */
	public void setRefinedRelation(DummyRelation newRefinedRelation) {
		DummyRelation oldRefinedRelation = refinedRelation;
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			...
			case QVTOperationalPackage.MAPPING_OPERATION__MERGED:
				...
				return;
			case QVTOperationalPackage.MAPPING_OPERATION__REFINED_RELATION:
				setRefinedRelation((DummyRelation)newValue);
				return;
			case QVTOperationalPackage.MAPPING_OPERATION__WHEN:
	...
	public void eUnset(int featureID) {
		switch (featureID) {
			...
			case QVTOperationalPackage.MAPPING_OPERATION__MERGED:
				...
				return;
			case QVTOperationalPackage.MAPPING_OPERATION__REFINED_RELATION:
				setRefinedRelation((DummyRelation)null);
				return;
			case QVTOperationalPackage.MAPPING_OPERATION__WHEN:
	...
	public <R> R accept(Visitor<R> visitor) {
		return (R) ((QVTOperationalVisitor<?>)visitor).visitMappingOperation(this);
	}
