...
public class ImperativeOCLQualifiedLookupVisitor
	extends AbstractImperativeOCLCommonLookupVisitor
{
    ...
    public ImperativeOCLQualifiedLookupVisitor(/*@NonNull*/ LookupEnvironment context) {
        super(context);
    ...
    @Override
    protected PivotQualifiedLookupVisitor createSuperLangVisitor() {
        return new PivotQualifiedLookupVisitor(context);}
}
