...
import org.eclipse.ocl.pivot.utilities.PivotASSaverResolveVisitor;
 ...
 */
public abstract class AbstractImperativeOCLASSaverResolveVisitor
	extends PivotASSaverResolveVisitor
	implements ImperativeOCLVisitor<Object>
{
	 ...
	 */
	protected AbstractImperativeOCLASSaverResolveVisitor(@NonNull ASSaver context) {
		super(context);
	}	
