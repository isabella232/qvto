...
public class QVTOperationalGrammarResource extends AbstractGrammarResource
{
	...
	private static class _QVTOperational
	{
		...
		private static final @NonNull ParserRule PR_OperationBodyCS = createParserRule("OperationBodyCS", createTypeRef(MM, org.eclipse.qvto.examples.xtext.qvtoperationalcs.QVTOperationalCSPackage.Literals.OPERATION_BODY_CS));
		...
		private static void initParserRules() {
			...
			PR_EntryOperationCS.setAlternatives(createGroup(createKeyword("main"), createKeyword("("), createKeyword(")"), createAssignment("body", "=", createRuleCall(PR_OperationBodyCS)), setCardinality("?", createKeyword(";"))));
			...
			PR_MappingOperationHeaderCS.setAlternatives(createGroup(setCardinality("*", createAssignment("qualifiers", "+=", createRuleCall(PR_OperationQualifier))), createKeyword("mapping"), setCardinality("?", createAssignment("direction", "=", createRuleCall(ER_DirectionKindCS))), createAssignment("scopedName", "=", createRuleCall(PR_PathName2CS)), createKeyword("("), setCardinality("?", createGroup(createAssignment("ownedParameters", "+=", createRuleCall(PR_ParameterDeclarationCS)), setCardinality("*", createGroup(createKeyword(","), createAssignment("ownedParameters", "+=", createRuleCall(PR_ParameterDeclarationCS)))))), createKeyword(")"), setCardinality("?", createGroup(createKeyword(":"), createAssignment("results", "+=", createRuleCall(PR_ParameterDeclarationCS)), createGroup(createKeyword(","), createAssignment("results", "+=", createRuleCall(PR_ParameterDeclarationCS))))), createUnorderedGroup(setCardinality("?", createGroup(createKeyword("inherits"), createAssignment("inherits", "+=", createRuleCall(PR_PathName2CS)), setCardinality("*", createGroup(createKeyword(","), createAssignment("inherits", "+=", createRuleCall(PR_PathName2CS)))))), setCardinality("?", createGroup(createKeyword("merges"), createAssignment("merges", "+=", createRuleCall(PR_PathName2CS)), setCardinality("*", createGroup(createKeyword(","), createAssignment("merges", "+=", createRuleCall(PR_PathName2CS)))))), setCardinality("?", createGroup(createKeyword("disjuncts"), createAssignment("disjuncts", "+=", createRuleCall(PR_PathName2CS)), setCardinality("*", createGroup(createKeyword(","), createAssignment("disjuncts", "+=", createRuleCall(PR_PathName2CS)))))), setCardinality("?", createGroup(createKeyword("refines"), createAssignment("refines", "=", createRuleCall(PR_PathName2CS))))), setCardinality("?", createGroup(createKeyword("when"), createAssignment("when", "=", createRuleCall(_ImperativeOCL.PR_ExpressionBlockCS)))), setCardinality("?", createGroup(createKeyword("where"), createAssignment("where", "=", createRuleCall(_ImperativeOCL.PR_ExpressionBlockCS))))));
			...
			PR_ModuleOperationCS.setAlternatives(createAlternatives(createRuleCall(PR_EntryOperationCS), createRuleCall(PR_MappingOperationCS)));
			...
			PR_OperationBodyCS.setAlternatives(createGroup(createAction(null, null, createTypeRef(MM, org.eclipse.qvto.examples.xtext.qvtoperationalcs.QVTOperationalCSPackage.Literals.OPERATION_BODY_CS)), createKeyword("{"), setCardinality("*", createAssignment("expressions", "+=", createRuleCall(_ImperativeOCL.PR_ExpressionStatementCS))), createKeyword("}")));
	...
	private static class _ImperativeOCL
	{
		...
		private static final @NonNull TerminalRule TR_SEVERITY_KIND = createTerminalRule("SEVERITY_KIND", createTypeRef(MM_ecore, org.eclipse.emf.ecore.EcorePackage.Literals.ESTRING));
		
		private static void initTerminalRules() {
			TR_SEVERITY_KIND.setAlternatives(createAlternatives(createKeyword("error"), createKeyword("fatal"), createKeyword("warning")));
		}
		...
		private static void initParserRules() {
			PR_AssertExpCS.setAlternatives(createGroup(createKeyword("assert"), setCardinality("?", createAssignment("severity", "=", createRuleCall(TR_SEVERITY_KIND))), createAssignment("ownedAssertion", "=", createRuleCall(_EssentialOCL.PR_ExpCS)), setCardinality("?", createGroup(createKeyword("with"), createAssignment("ownedLog", "=", createRuleCall(PR_LogExpCS))))));
			PR_AssignExpCS.setAlternatives(createGroup(createAssignment("ownedLeft", "=", createRuleCall(_EssentialOCL.PR_NameExpCS)), createAssignment("assignOp", "=", createAlternatives(createKeyword(":="), createKeyword("::="), createKeyword("+="))), createAssignment("ownedValue", "=", createRuleCall(_EssentialOCL.PR_ExpCS)), setCardinality("?", createGroup(createKeyword("default"), createAssignment("ownedDefault", "=", createRuleCall(_EssentialOCL.PR_ExpCS))))));
			...
			PR_SwitchExpCS.setAlternatives(createGroup(createKeyword("if"), createAssignment("ownedAltParts", "+=", createRuleCall(PR_SwitchAltCS)), setCardinality("*", createGroup(createKeyword("elif"), createAssignment("ownedAltParts", "+=", createRuleCall(PR_SwitchAltCS)))), setCardinality("?", createGroup(createKeyword("else"), createAssignment("ownedElsePart", "=", createRuleCall(_EssentialOCL.PR_ExpCS)))), setCardinality("?", createKeyword("endif"))));
