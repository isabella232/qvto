...
public class QVTOperationalGrammarResource extends AbstractGrammarResource
{
	...
	private static class _QVTOperational
	{
		...
		private static void initParserRules() {
			...
			PR_TopLevelCS.setAlternatives(createGroup(setCardinality("*", createAssignment("import", "+=", createRuleCall(PR_ImportCS))), setCardinality("*", createAssignment("ownedPackages", "+=", createRuleCall(PR_UnitPacakgeCS))), createAssignment("unit", "+=", createRuleCall(PR_TransformationCS))));
