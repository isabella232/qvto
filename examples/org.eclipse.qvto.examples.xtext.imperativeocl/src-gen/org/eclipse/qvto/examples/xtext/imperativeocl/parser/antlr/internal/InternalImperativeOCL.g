...
entryRuleGrammmarCS returns [EObject current=null]
	:
	{ newCompositeNode(grammarAccess.getGrammmarCSRule()); }
	 iv_ruleGrammmarCS=ruleGrammmarCS
	 { $current=$iv_ruleGrammmarCS.current; }
	 EOF
;

// Rule GrammmarCS
ruleGrammmarCS returns [EObject current=null]
    @init { enterRule();
    }
    @after { leaveRule(); }:
    ...
    {
        $current = $this_ImperativeOCLExpCS_0.current;
