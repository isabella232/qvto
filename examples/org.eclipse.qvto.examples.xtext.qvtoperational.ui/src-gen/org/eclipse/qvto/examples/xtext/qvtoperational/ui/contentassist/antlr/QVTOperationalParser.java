		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getTopLevelCSAccess().getOwnedPackagesAssignment_1(), "rule__TopLevelCS__OwnedPackagesAssignment_1");
					put(grammarAccess.getTopLevelCSAccess().getUnitAssignment_2(), "rule__TopLevelCS__UnitAssignment_2");
					...
					put(grammarAccess.getTransformationDefCSAccess().getOwnedPropertiesAssignment_2(), "rule__TransformationDefCS__OwnedPropertiesAssignment_2");
					put(grammarAccess.getTransformationDefCSAccess().getOwnedOperationsAssignment_3(), "rule__TransformationDefCS__OwnedOperationsAssignment_3");
					...
					put(grammarAccess.getMappingOperationHeaderCSAccess().getOwnedParametersAssignment_3_0(), "rule__MappingOperationHeaderCS__OwnedParametersAssignment_3_0");
					put(grammarAccess.getMappingOperationHeaderCSAccess().getOwnedParametersAssignment_3_1_1(), "rule__MappingOperationHeaderCS__OwnedParametersAssignment_3_1_1");
					...
					put(grammarAccess.getTemplateBindingCSAccess().getOwnedSubstitutionsAssignment_1(), "rule__TemplateBindingCS__OwnedSubstitutionsAssignment_1");
					put(grammarAccess.getTemplateBindingCSAccess().getOwnedSubstitutionsAssignment_2_1(), "rule__TemplateBindingCS__OwnedSubstitutionsAssignment_2_1");
