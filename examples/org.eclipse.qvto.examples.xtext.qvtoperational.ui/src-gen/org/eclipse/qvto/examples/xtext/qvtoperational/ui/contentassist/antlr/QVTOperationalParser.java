		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getOperationBodyCSAccess().getGroup(), "rule__OperationBodyCS__Group__0");
					...
					put(grammarAccess.getEntryOperationCSAccess().getBodyAssignment_3(), "rule__EntryOperationCS__BodyAssignment_3");
					put(grammarAccess.getOperationBodyCSAccess().getExpressionsAssignment_2(), "rule__OperationBodyCS__ExpressionsAssignment_2");
