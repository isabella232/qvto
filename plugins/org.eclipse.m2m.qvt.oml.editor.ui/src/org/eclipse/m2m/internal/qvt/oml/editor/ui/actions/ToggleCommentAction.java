...
public final class ToggleCommentAction extends TextEditorAction {
	...
	public void run() {
		...
		if (!fOperationTarget.canDoOperation(operationCode)) {
			if (shell != null)
				MessageDialog.openError(shell, ActionMessages.getString("ToggleComment_error_title"), //$NON-NLS-1$
						ActionMessages.getString("ToggleComment_error_message")); //$NON-NLS-1$
			return;
		}
