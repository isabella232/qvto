...
/**
 * This is the item provider adapter for a {@link simpleuml.Package} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class PackageItemProvider
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(simpleuml.Package.class)) {
		...
		newChildDescriptors.add
			(createChildParameter
				(SimpleumlPackage.Literals.PACKAGE__OWNED_ELEMENTS,
				 SimpleumlFactory.eINSTANCE.createPackage()));

		newChildDescriptors.add
			(createChildParameter
				(SimpleumlPackage.Literals.PACKAGE__OWNED_ELEMENTS,
				 SimpleumlFactory.eINSTANCE.createModel()));

		newChildDescriptors.add
			(createChildParameter
				(SimpleumlPackage.Literals.PACKAGE__OWNED_ELEMENTS,
				 SimpleumlFactory.eINSTANCE.createDataType()));

		newChildDescriptors.add
			(createChildParameter
				(SimpleumlPackage.Literals.PACKAGE__OWNED_ELEMENTS,
				 SimpleumlFactory.eINSTANCE.createClass()));

		newChildDescriptors.add
			(createChildParameter
				(SimpleumlPackage.Literals.PACKAGE__OWNED_ELEMENTS,
				 SimpleumlFactory.eINSTANCE.createAssociation()));

		newChildDescriptors.add
			(createChildParameter
				(SimpleumlPackage.Literals.PACKAGE__OWNED_ELEMENTS,
				 SimpleumlFactory.eINSTANCE.createPrimitiveType()));
