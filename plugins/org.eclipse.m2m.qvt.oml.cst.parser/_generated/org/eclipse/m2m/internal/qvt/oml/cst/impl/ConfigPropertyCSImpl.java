 ...
 * <ul>
 *   <li>{@link org.eclipse.m2m.internal.qvt.oml.cst.impl.ConfigPropertyCSImpl#getTypeCS <em>Type CS</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ConfigPropertyCSImpl extends ModulePropertyCSImpl implements ConfigPropertyCS {
	...
	protected EClass eStaticClass() {
		return CSTPackage.Literals.CONFIG_PROPERTY_CS;
	}
	...
	public NotificationChain basicSetTypeCS(TypeCS newTypeCS, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, CSTPackage.CONFIG_PROPERTY_CS__TYPE_CS, oldTypeCS, newTypeCS);
	...
	public void setTypeCS(TypeCS newTypeCS) {
		if (newTypeCS != typeCS) {
			...
			if (typeCS != null)
				msgs = ((InternalEObject)typeCS).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - CSTPackage.CONFIG_PROPERTY_CS__TYPE_CS, null, msgs);
			if (newTypeCS != null)
				msgs = ((InternalEObject)newTypeCS).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - CSTPackage.CONFIG_PROPERTY_CS__TYPE_CS, null, msgs);
			msgs = basicSetTypeCS(newTypeCS, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CSTPackage.CONFIG_PROPERTY_CS__TYPE_CS, newTypeCS, newTypeCS));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case CSTPackage.CONFIG_PROPERTY_CS__TYPE_CS:
