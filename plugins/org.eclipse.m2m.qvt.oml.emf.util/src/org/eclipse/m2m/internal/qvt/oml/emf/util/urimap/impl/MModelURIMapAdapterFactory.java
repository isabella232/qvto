...
public class MModelURIMapAdapterFactory extends AdapterFactoryImpl {
	 ...
	 * @generated
	 */
	protected MModelURIMapSwitch<Adapter> modelSwitch =
		new MModelURIMapSwitch<Adapter>() {
			@Override
	...
	/**
	 * Creates a new adapter for an object of class '{@link org.eclipse.m2m.internal.qvt.oml.emf.util.urimap.MappingContainer <em>Mapping Container</em>}'.
	 * <!-- begin-user-doc -->
	...
	/**
	 * Creates a new adapter for an object of class '{@link org.eclipse.m2m.internal.qvt.oml.emf.util.urimap.URIMapping <em>URI Mapping</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
