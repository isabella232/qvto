 ...
 * </copyright>
 *
 * $Id: BlockExpImpl.java,v 1.3 2009/02/06 15:47:30 radvorak Exp $
 */
 ...
 * <ul>
 *   <li>{@link org.eclipse.m2m.qvt.oml.ecore.ImperativeOCL.impl.BlockExpImpl#getBody <em>Body</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class BlockExpImpl extends ImperativeExpressionImpl implements BlockExp {
	...
	public <T, U extends Visitor<T, ?, ?, ?, ?, ?, ?, ?, ?, ?>> T accept(U v) {
		if (v instanceof ImperativeOCLVisitor)
			return (T) ((ImperativeOCLVisitor) v).visitBlockExp(this);
