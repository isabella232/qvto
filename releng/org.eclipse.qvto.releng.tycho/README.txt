...
or installing new software from e.g. http://download.eclipse.org/mmt/qvto/updates/milestones/3.9.3/S201805290850
...
cd ~/downloads/mmt/qvto/updates/milestones/3.9.3
ant -f /shared/modeling/tools/promotion/manage-composite.xml add -Dchild.repository=S201805290850 [ -Dcomposite.name="QVTo 3.9.3 milestones" ]

(This can be checked by installing new software from e.g. http://download.eclipse.org/mmt/qvto/updates/milestones/3.9.3)
...
location="http://download.eclipse.org/mmt/qvto/updates/releases/3.9.3"

Downloads are accessible at
cd ~/downloads/mmt/qvto/downloads/drops/3.9.3
