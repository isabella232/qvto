...
or installing new software from e.g. http://download.eclipse.org/mmt/qvto/updates/milestones/3.9.0/S201805290850
...
cd downloads/mmt/qvto/updates/milestones/3.9.0
ant -f /shared/modeling/tools/promotion/manage-composite.xml add -Dchild.repository=S201805290850 [ -Dcomposite.name="QVTo 3.9.0 milestones" ]

(This can be checked by installing new software from e.g. http://download.eclipse.org/mmt/qvto/updates/milestones/3.9.0)
...
location="http://download.eclipse.org/mmt/qvto/updates/milestones/3.9.0/S201805290850"
commit with a comment such as [qvto] 3.9.0M5 for Photon and Push to Gerrit (refs/for/master)
...
location="http://download.eclipse.org/mmt/qvto/updates/releases/3.9.0"

Downloads are accessible at
cd downloads/mmt/qvto/downloads/drops/3.9.0
